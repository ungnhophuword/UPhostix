...
export default function HomeView({ setCurrentTab, onSelectProject, onSelectBlogPost }: HomeViewProps) {
  ...
  const [newFeedbackHoverRating, setNewFeedbackHoverRating] = useState<number | null>(null);
  ...
  const handleSubmitFeedback = (e: React.FormEvent) => {
    ...
    toast.success(`Cảm ơn anh/chị ${newFeedbackName} đã gửi phản hồi và chấm điểm ${newFeedbackRating} sao cho UPhostix!`);
  };
  ...
  return (
    <div id="home-view" className="space-y-32 pb-24 overflow-hidden">
      {/* 🚀 HERO SECTION */}
      <section id="hero-section" className="relative pt-36 lg:pt-44 bg-transparent">
        ...
        <div className="absolute bottom-[10%] left-[45%] w-16 h-16 rounded-full border border-emerald-400/10 pointer-events-none -z-10 animate-float" style={{ animationDuration: '7s' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                Chúng tôi tạo ra những website tốc độ tải trang thần tốc, trải nghiệm giao diện số lộng lẫy kết hợp chiến lược SEO bền vững đưa doanh nghiệp dẫn đầu thứ hạng tìm kiếm.
              </motion.p>
              ...
              >
                <div>
                  <p className="text-3xl font-bold text-white font-display">150+</p>
                  <p className="text-xs text-slate-400 mt-1 uppercase tracking-wider">Dự Án Đỉnh Cao</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-white font-display">99%</p>
                  <p className="text-xs text-slate-400 mt-1 uppercase tracking-wider">Khách Hàng Hài Lòng</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-white font-display">&lt; 0.5s</p>
                  <p className="text-xs text-slate-400 mt-1 uppercase tracking-wider">Tốc Độ Tải Bàn Giao</p>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <div className="relative bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuDL8BSb9YtVoRpsOVxgb1j5O3OLO_6emfqprRxGPDi9DrMkLKJBQAOrghqNLuKI5lsyX5_RdmVMCU-x3VQGnjtyGAu_RlMj1Plf3s9Oak_AmiO-TEHhVKduk4nCKxlpAb2HPSjvilpN-6AuMhrsSbfuydRUxd_aBDyeXBxz7mNzptFDYcYWolBE138sEf0G3kw55WGDDHJo8jBiH_NeDAdlVpNFtBMvfn_g3jNG4t7fyBe_Asun9JdkzqmnC8Vbl7j69pvGU7BWM8PT"
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-slate-950/80 backdrop-blur-md p-4 rounded-xl border border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white text-xs font-semibold">Tối Ưu SEO Hoàn Hảo</p>
                      <p className="text-slate-400 text-[10px]">Google Core Web Vitals 100/100</p>
                    </div>
                  </div>
                  <span className="text-blue-400 font-mono text-xs font-semibold px-2 py-1 bg-blue-500/10 rounded-md">Responsive</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section id="features-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-blue-400 text-xs font-bold uppercase tracking-widest bg-blue-950/40 px-3.5 py-1.5 rounded-full border border-blue-800/40">Dịch Vụ Kinh Điển</span>
          <h2 className="text-3xl sm:text-4xl font-bold font-display text-white tracking-tight">Giải Pháp Toàn Diện Cho Chuyển Đổi Số</h2>
          <p className="text-slate-400 leading-relaxed text-sm sm:text-base">Chúng tôi thiết kế những trải nghiệm sản phẩm số mượt mà, định chuẩn tối giản sang trọng đem lại chuyển đổi tối đa.</p>
        </div>
          ...
          {SERVICES.map((serv) => (
            ...
            >
              <div className="space-y-4">
                ...
                <h3 className="text-white text-lg font-bold font-display tracking-tight">{serv.title}</h3>
                <p className="text-slate-400 text-sm leading-relaxed line-clamp-3">{serv.description}</p>
              </div>
              <div className="pt-6 mt-6 border-t border-slate-800/60 flex items-center justify-between">
                <span className="text-xs text-slate-500">Báo giá từ {serv.pricing.basic.split('/')[0]}</span>
                <button
                  onClick={() => {
                    setCurrentTab('services');
                    window.scrollTo({ top: 0, behavior: 'smooth' });
      ...
      <section id="workflow-section" className="bg-transparent relative py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-20">
            <span className="text-emerald-400 text-xs font-bold uppercase tracking-widest bg-emerald-950/40 px-3 py-1 rounded-full border border-emerald-800/50">Quy Trình Chuẩn</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-display text-white tracking-tight">Vận Hành Chuyên Nghiệp Trong Từng Dự Án</h2>
            <p className="text-slate-400 text-sm sm:text-base leading-relaxed">Chúng tôi phân phối khối lượng công việc thành các cột mốc chi tiết để đảm bảo tỷ lệ phản hồi dự án luôn đạt đỉnh cao.</p>
          </div>
          ...
          >
            ...
            {[
              { step: '01', title: 'Phân Tích & Định Hướng', desc: 'Nghiên cứu thị trường cạnh tranh, lập bảng từ khóa chuẩn SEO onpage giải quyết trọn nỗi lo quảng cáo tốn kém.' },
              { step: '02', title: 'Thiết Kế UI/UX Độc Bản', desc: 'Kiến tạo layout tinh tế, không gian âm mở rộng tạo sự thông thoáng, phản chiếu đúng đẳng cấp thương hiệu.' },
              { step: '03', title: 'Phát Triển & SEO On-page', desc: 'Code tối ưu tốc độ nhanh dưới 0.5 giây, tự động nén dữ liệu, dọn sạch code thừa cho bot bò tiện lợi.' },
              { step: '04', title: 'Bàn Giao & Bảo Trì Trọn Đời', desc: 'Lớp tường rào bảo vệ vững bền, hướng dẫn trực quan 1-1 hỗ trợ bảo trì, nâng cấp cấu trúc lâu dài.' }
            ].map((wf, idx) => (
              <motion.div
                variants={fadeInUp}
                key={idx}
              ...
              >
                ...
                <h3 className="text-white text-base sm:text-lg font-bold font-display tracking-tight group-hover:text-blue-400 transition-colors">{wf.title}</h3>
                <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">{wf.desc}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section id="portfolio-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16">
          <div className="space-y-4 max-w-2xl">
            <span className="text-blue-400 text-xs font-bold uppercase tracking-widest bg-blue-950/40 px-3 py-1 rounded-full border border-blue-800/40">Dự Án Tiêu Biểu</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-display text-white tracking-tight">Ký Sự Thiết Kế & Số Hóa Thương Hiệu</h2>
            <p className="text-slate-400 text-sm leading-relaxed">Khám phá kho dự án thiết kế và bứt phá doanh số chúng tôi đã trực tiếp vận hành cho các tổng đối tác.</p>
          </div>
          <button
            onClick={() => {
        ...
        >
          {PROJECTS.map((proj, idx) => {
            const colSpanClass = idx === 0 || idx === 3 ? 'lg:col-span-7' : 'lg:col-span-5';
            return (
              <motion.div
                variants={fadeInUp}
                key={proj.id}
              ...
              >
                ...
                <div className="relative overflow-hidden aspect-[16/10]">
                  ...
                  {proj.stats && (
                    <div className="absolute bottom-4 left-4 bg-slate-950/80 backdrop-blur-md px-3.5 py-1.5 rounded-xl border border-white/5 text-xs text-white flex items-center gap-2">
                      ...
                      <span className="font-semibold text-slate-300">{proj.stats.label}:</span>
                      <span className="font-bold text-blue-400 font-display text-sm">{proj.stats.value}</span>
                    </div>
                  )}
                ...
                <div className="p-6 space-y-3 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-400 text-sm leading-relaxed mt-2 line-clamp-2">{proj.description}</p>
                  </div>
                  <div className="flex flex-wrap gap-2 pt-4 justify-between items-center">
                    <div className="flex flex-wrap gap-1.5">
                      {proj.tags.map((tg, i) => (
                        <span key={i} className="text-[10px] bg-slate-950/80 text-slate-400 border border-slate-850 px-2 py-0.5 rounded-md">
                          {tg}
                        </span>
                      ))}
                    </div>
      ...
      <section id="recent-blog-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16">
          <div className="space-y-4 max-w-2xl">
            <span className="text-blue-400 text-xs font-bold uppercase tracking-widest bg-blue-950/40 px-3.5 py-1.5 rounded-full border border-blue-800/40">Góc Chia Sẻ</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-display text-white tracking-tight">Bài Viết & Ý Tưởng Mới Nhất</h2>
            <p className="text-slate-400 text-sm leading-relaxed">Cập nhật xu thế thiết kế và tối ưu On-page từ các chuyên gia hàng đầu trong lĩnh vực kỹ thuật số.</p>
          </div>
          <button
            onClick={() => {
              setCurrentTab('blog');
              ...
              <div className="p-5 flex flex-col justify-between flex-grow">
                ...
                <div className="pt-4 mt-6 border-t border-slate-850/60 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <img src={post.author.avatar} alt={post.author.name} referrerPolicy="no-referrer" className="w-6 h-6 rounded-full object-cover border border-slate-800" />
      ...
      <section id="testimonials-section" className="bg-transparent py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
            <span className="text-blue-400 text-xs font-bold uppercase tracking-widest bg-blue-950/40 px-3 py-1 rounded-full border border-blue-850/30">Phản Hồi Đồng Hành</span>
            <h2 className="text-3xl sm:text-4xl font-bold font-display text-white tracking-tight">Ý Kiến Thực Tế Từ Khách Hàng</h2>
            <p className="text-slate-400 text-sm sm:text-base leading-relaxed">Chúng tôi duy trì cam kết và giữ trọn chữ tín cao nhất trên mỗi website xuất xưởng.</p>
          </div>
                ...
                {testimonialsList.map((test) => (
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <p className="text-slate-300 text-sm leading-relaxed italic">"{test.content}"</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3 pt-6 mt-6 border-t border-slate-800/60 w-full overflow-hidden">
                      ...
                      <div className="overflow-hidden">
                        <h4 className="text-white text-sm font-bold tracking-wide truncate">{test.name}</h4>
                        <p className="text-slate-500 text-xs truncate">{test.role} - <span className="text-blue-400/80">{test.company}</span></p>
                      </div>
                    </div>
                  </motion.div>
                ))}
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-28 bg-slate-900/40 backdrop-blur-md rounded-3xl border border-slate-800/80 p-6 sm:p-8 hover:border-blue-500/20 transition-all duration-300 space-y-6">
                <div>
                  ...
                  <p className="text-slate-400 text-xs sm:text-sm mt-1">Đánh giá sao động thực quản và đóng góp phản hồi quý báu cho đội ngũ kỹ sư UPhostix.</p>
                </div>

                <form onSubmit={handleSubmitFeedback} className="space-y-4 text-left">
                  {/* Interactive Dynamic Star Selection */}
                  <div className="space-y-2">
                    <label className="text-xs font-semibold text-slate-300 block uppercase tracking-wider">Đánh Giá Sao Động</label>
                    <div className="flex items-center gap-1.5 py-1">
                      {[1, 2, 3, 4, 5].map((starVal) => {
                        const isLit = (newFeedbackHoverRating !== null) 
                        ...
                        return (
                          <button
                            ...
                            onMouseEnter={() => setNewFeedbackHoverRating(starVal)}
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-slate-300 block uppercase tracking-wider">Nội Dung Nhận Xét *</label>
                    <textarea
                      required
                      rows={3}
                  ...
                  {/* Personal details */}
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-slate-300 block uppercase tracking-wider">Họ & Tên *</label>
                    <input
                      required
                      type="text"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-semibold text-slate-400 block uppercase tracking-wider">Chức Vụ</label>
                      <input
                        type="text"
                        placeholder="VD: CEO"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-semibold text-slate-400 block uppercase tracking-wider">Doanh Nghiệp</label>
                      <input
                        type="text"
      ...
      {/* 🚀 CALL TO ACTION */}
      <section id="cta-footer-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-950/30 via-slate-900 to-slate-950 border border-blue-500/10 rounded-3xl p-8 sm:p-12 lg:p-16 text-center space-y-6">
          ...
          <p className="text-slate-300 text-sm sm:text-base max-w-xl mx-auto">
            Hãy kết nối với các kiến trúc sư giải pháp của UPhostix để nhận tư vấn cấu trúc nâng cấp web, phân tích SEO độc quyền hoàn toàn miễn phí.
          </p>
